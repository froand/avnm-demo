# AVNM DNB Demo — Rehearsal Script

Sub: `5d648a29-5d8e-4da2-a0f8-9a640b313144` | RG: `AVNM` | Network Manager: `AVNM-Demo` | Region: `swedencentral`

**Before you start:** `az account set --subscription 5d648a29-5d8e-4da2-a0f8-9a640b313144`
...
## Scenario 4 — Security Admin Rules Supersede NSG (5 min) — the strongest DNB moment
